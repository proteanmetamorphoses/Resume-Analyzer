...
function Dashboard() {
  ...
  const testResponses = () => {
    setIsTest(true);
    setShowRevisionSection(true);
    setResumeKeywords(["Job Coach", "Trainer", "Process Development", "Software Prototype Development", "Project Coordinator", "Software Tester", "Marketing Materials Development", "Operations", "OHS Program Implementation", "HR Duties", "Commercialization Associate", "Document Digitization", "Client Account Management", "RFP Writing", "Microsoft Excel VBA", "Scrum Project Coordinator", "Software Development", "Zoom Training", "Server Setup", "ActiveCare Software", "Office Management", "Parking Patroller", "Online Instructor", "Curriculum Development", "ESL Teaching", "Department Coordinator", "Quality Assurance", "Research Projects", "Corporate Training", "Customer Service", "Landscaping", "Education in React, HTML, CSS, JavaScript", "Programming Languages (VBA, JavaScript, HTML5, CSS3, Python, Java, C++, React framework)", "Volunteer Experience"]);
    setJobDescriptionKeywords(["Front-End Development","React","JavaScript","HTML","CSS","Storybook","Cypress","Git","Upper-Intermediate English","Fast Learning","Attention to Detail","Enthusiastic Attitude","Next.js","Bachelor's or Master's degree (Computer Science, IT, Software Engineering)","Cross-functional collaboration","Styled Components","TypeScript","Code Reviews","Node.js","Strapi","Cloudflare Workers","Cloudflare Durable Objects","Vercel","Cloudflare Pages","Serverless functions","CI/CD","RestAPI","GraphQL","Remote Work","Competitive Compensation","Training and Development"]);    setAtsScore(70);
    setIsAnalyzing(false);
    setAnalysisCompleted(true);
    setShowResults(true);
    setShowFinalResults(true);
    setMissingKeywords(["Styled Components","TypeScript","Node.js","Strapi","Cloudflare Workers","Cloudflare Durable Objects","Serverless functions","CI/CD","RestAPI","GraphQL"]);
    setAssessment("Steven Kurowski's resume demonstrates a strong background in various aspects of technology and education, with a focus on software development, project coordination, and training. His experience with React, JavaScript, HTML, and CSS aligns well with the job description's requirements for a Front-End Developer. Additionally, his experience with software testing, client management, and RFP writing could be beneficial for understanding project requirements and contributing to the development process.  However, there are several missing keywords related to specific technologies and methodologies mentioned in the job description that are not present in the resume, such as Next.js, TypeScript, Node.js, Strapi, Cloudflare Workers, Cloudflare Durable Objects, serverless functions, CI/CD, Github Actions, RestAPI, and GraphQL. This indicates a potential gap in Steven's experience with these particular skills and tools.");
  ...
  return (
    <div className="dashboard">
      ...
      <h2 className="Main-Header">Revise Your Resume and Craft a Complementary Cover Letter with AI</h2>
